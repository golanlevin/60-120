...
* [**Pandemic Guidelines**](#pandemic-guidelines)
...
2. **No Ghosting.** Attendance is important, but if you need to miss class — which happens — be responsible about communicating with the professor about your absence.
...
1. **Machine Learning:** experimentation with new tools for image synthesis (using e.g. *Midjourney*) 
...
4. **Internet Ready-Made**: single-serving websites for digital curation (using 
